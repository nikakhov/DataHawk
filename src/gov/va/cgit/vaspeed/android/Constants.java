...
public class Constants {
  ...
  public static final String privacyPolicyURL="http://www.cgit.vt.edu/index.html";
  ...
  public static final String dataServers[]={
	  "54.213.93.173", //Update this to your database server
  };
  
  //use format such as /test (default) or /test/test2
  public static final String dataServerDir="/test";
  //default is http://metagrid2.sv.vt.edu/~sharni/SpeedTest
  public static final String fillAPIPath="http://54.213.93.173/HawkPsql/";
...
//Network (physical layer) types
  ...
  public static final String SERVER_HOST[] =
     {"54.213.93.173", "54.213.93.173"}; // Update to two Iperf servers
...
*/
  public static final int ATT_TCP_Port = 5001;
  public static final int ATT_UDP_Port = 5001;
  public static final int Sprint_TCP_Port = 5001;
  public static final int Sprint_UDP_Port = 5001;
  public static final int TMobile_TCP_Port = 5001;
  public static final int TMobile_UDP_Port = 5001;
  public static final int Verizon_TCP_Port = 5001;
  public static final int Verizon_UDP_Port = 5001;
  public static final int Other_TCP_Port = 5001;
  public static final int Other_UDP_Port = 5001;
  /**
